...
symlink_dir="$tmpdir/symlink-dir"
mkdir -p "$symlink_dir"
make_valid_bundle_dir "$symlink_dir"
ln -s /etc/passwd "$symlink_dir/nodes/monitor01/system/outside-link"
...
assert_fail "$symlink_dir" "symlink"
